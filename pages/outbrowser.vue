<template>
  <div class="noajax  home chromeBg allowHover">
    <div id="container" class="container effect">
      <div class="pusher">
            ...
            <div class="inner">
              ...
              <header class="title" role="banner">
                <div class="browserVersion newBrowser">
                  <h1>您的浏览器已过时</h1>
                  <p style="font-size:16px;">为了更佳的浏览体验，将您的浏览器保持最新。在这里您可以获得最新的版本。</p>
                </div>
        ...
        -->
              <section class="c_browsers sorted kwicks kwicks-horizontal kwicks-processed">

                <!-- BROWSER - Chrome -->
                <div id="chrome" class="browser">
                  <h3 class="statistic">
                    <span>63.6%</span> 的人们在使用 <br>这款浏览器</h3>
                  <div class="center">
                    <h2>
                      <span></span> GOOGLE CHROME</h2>
                    <div class="download">
                      <a href="https://www.google.com/chrome/browser/desktop/" target="_blank" class="browserlink" data-track="Google Chrome">下载</a>
                      <h4>版本
                        <span>67</span>
                      </h4>
                    </div>
                ...
                <div id="firefox" class="browser">
                  <h3 class="statistic">
                    <span>13.8%</span> 的人们在使用 <br>这款浏览器</h3>
                  <div class="center">
                    <h2>
                      <span></span> MOZILLA FIREFOX</h2>
                    <div class="download">
                ...
                <div id="internetExplorer" class="browser">
                  <h3 class="statistic">
                    <span>4.1%</span> 的人们在使用 <br>这款浏览器</h3>
                  <div class="center">
                    <h2 class="edge">
                      <span></span> MICROSOFT EDGE </h2>
                    <div class="download">
                      <a class="edge-btn" href="https://www.microsoft.com/software-download/windows10" target="_blank" data-track="Internet Explorer">下载WIN10</a>
                      <h4>版本
                        <span>16</span>
                      </h4>
                      <h5>仅适用于Windows 10</h5>
                    </div>
                  </div>
                  <div class="available">
                    <h4>在以下操作系统可用 </h4>
                ...
                <div id="safari" class="browser">
                  <h3 class="statistic">
                    <span>5.5%</span> 的人们在使用 <br>这款浏览器</h3>
                  <div class="center">
                    <h2>
                      <span></span> APPLE SAFARI</h2>
                    <div class="download">
                      <a class="macos-btn" href="http://www.apple.com/osx/" target="_blank" data-track="Apple Safari">下载MACOS</a>
                      <h4>版本
                        <span>11</span>
                      </h4>
                      <h5>仅适用于macOS</h5>
                ...
                <div id="opera" class="browser">
                  <h3 class="statistic">
                    <span>2.4%</span> 的人们在使用 <br>这款浏览器</h3>
                  <div class="center">
                    <h2>
                      <span></span> OPERA</h2>
                    <div class="download">
                      <a href="http://www.opera.com/?utm_medium=roc&amp;utm_source=burocratik&amp;utm_campaign=outdatedbrowser" target="_blank" data-track="Opera" class="browserlink">下载</a>
                      <h4>版本
                        <span>54</span>
                      </h4>
                    </div>
...
.menu_open .lang-picker.scrolling:after {
  ...
  top: 68px;
  left: 0;
  background: url(/imgs/lang_shadow.png) center no-repeat rgba(238, 79, 68, 0.4);
  background-size: 100%;
...
.effect.menu_open .pusher {
  ...
  cursor: -webkit-image-set(
      url(/imgs/close_.png) 1x,
      url(/imgs/close_@2x.png) 2x
    ),
    auto;
}
