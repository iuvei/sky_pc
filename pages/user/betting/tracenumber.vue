<template>
    <div  class="betrecord_box">
        <!-- <div class="box_header"><div class="head_icon"></div>追号记录</div> -->
        <div class="box_container no_select" id="dialog_userinfo">
                <div class="menu">
                    ...
                    <div class="item_3">状态:
                        ...
                        <!-- <div class="check_box" :class="{ active : loginfo.type==1}" @click="toggleType(1)">进行中</div>
                        <div class="check_box" :class="{ active : loginfo.type==2}" @click="toggleType(2)">已结束</div> -->
                    </div>
                </div>
                        ...
                        <table class="ex_custom_table">
                            <thead>
                                <tr>
                                    ...
                                    <!-- <td width="80">已追/总期数</td>
                                    <td width="80">已投/总金额</td> -->
                                    <td>追号时间</td>
                                    <td width="140">详情</td>
                            ...
                            <tbody>
                                <tr v-for="(item,index) in recorddata" class="detail_info" :key="index"  :class="{bgcolor:index%2==1}">
                                    ...
                                    <!-- <td width="100" class="lot_time"><span class="red">{{item.shijian}}</span><span>/</span><span>{{item.zongqi}}</span></td>
                                    <td width="80" class="bet_money"><span class="red">{{item.yitou}}</span><span>/</span><span>{{item.zongjine}}</span></td> -->
                                    <td>{{item.tz_time}}</td>
            ...
            <table class="title_table">
                <tbody  class="detail_main"> 
                    ...
                    <tr>
                        ...
                        <td><span>{{currentData.win}}</span>/<span>{{currentData.peilv}}</span></td>
...
export default {
    data(){
     ...
     mounted(){
       this.fetchGamelist()
       this.fetchData()
    //    console.log(this.showpagebtn);
    //    console.log(this.totalpage);
    //    console.log(this.dividerpage.totalpage);
    },
    computed:{
        // totalpage(){
    ...
    methods:{
        ...
        toggleTime(time){
            ...
            this.fetchData();
            // console.log(this.lastetime);
        },
        // toggleType(type){
        //     this.loginfo.type=type;
        //     this.fetchData();
            // console.log(this.loginfo.gameid);
        // },
        showDetail(item){
            if(item == 0){
                this.close=0;
        ...
        async  fetchData(){
            ...
            return rep;
            // let loginfo = $this.$store.dispatch("getUserTouZhuLog",this.loginfo);
            // console.log(loginfo)
            // return loginfo;
        },
        //获取玩法列表
...
<style lang="scss" scoped>
    ...
    .first_page, .btn_back, .btn_forward, .last_page{
        cursor: pointer;
    }
    .bet_detail{
        cursor: pointer;
