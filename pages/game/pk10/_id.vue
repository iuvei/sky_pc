<template>
  ...
  <div class='pk10'>
    ...
    <pk10Main :item="item" class="container"></pk10Main>
  </div>
</template>
<script>
import { mapState, mapActions } from "vuex";
// import gameHead from "~/components/game/gameHead";
// import gameHead from "~/components/game/pk10/GameHead";
import gameHead from "~/components/game/pk10/PK10Head";
import pk10Main from "~/components/game/pk10/main";
export default {
  name: "pk10",
  components: { gameHead, pk10Main },
  computed: {
