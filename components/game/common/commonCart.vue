  ...
  <div class='common-cart'>
    ...
    <div class="cart-main">
      ...
      <div class="cart-main-title" :class="{'low-speed':!isHighSpeed}">
        ...
        <div class="g-times" v-if="isHighSpeed">追
        ...
        <div class="senior-wrap" v-if="isHighSpeed">
...
export default {
  ...
  methods: {
    ...
    addLine(randomData) {
      let isDanshi =
        ...
        isRenxuan = this.$store.state.game.gameId * 1 == 54
      let betted = []
      if (this.stateOdds && !isDanshi && !isDanxuan && !isRenxuanOne) {
        betted = [
          {
  ...
  watch: {
    gameItem(val) {
      console.log('watch in cart', val)
      this.setShopCartInfo({
        stop: 1,
        multiple: 1,
        auto: 1
      })
