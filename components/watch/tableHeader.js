...
export const getTrendBallArr = {
  ...
  pkniuniu: new Array(10).fill(1).map((v, k) => k + 1),
  k3: new Array(6).fill(1).map((v, k) => k + 1),
  lhc: new Array(49).fill(1).map((v, k) => k + 1),
  pcdd: new Array(10).fill(1).map((v, k) => k),
  xypk: new Array(52).fill(1).map((v, k) => k),
  qxc: new Array(10).fill(1).map((v, k) => k),
  xync: new Array(20).fill(1).map((v, k) => k + 1)
}
